...
export default {
    ...
    methods: {
        ...
        getServices(){
            ...
            let config = {
                headers: {
                    'Autorization': 'Bearer' + this.user.api_token,
                }
            }
            this.axios.post('/services', formData, config)
            .then((response) => {
                let response_data = response.data
                //Jika tidak derror maka data service dan cart akan diupdate.
                if(response_data.status!='error'){
                    this.service = response_data.data.services
        ...
        calculateBill(){
            ...
            this.totalBill = parseInt(this.totalPrice) + parseInt(this)
        }
    },
    created(){
